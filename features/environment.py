...
def browser_init(context, test_name):
    ...
    chromedriver_path = '/Users/macbookpro/Desktop/QA_automation_program/apple-s_website_automation/chromedriver'
    ...
    #                               '"arguments": {"name": "Test_name_goes_here"}}')
